...
ActiveRecord::Schema.define(version: 20150130004242) do
  ...
  add_index "categorizings", ["entry_id"], name: "index_categorizings_on_entry_id"
  ...
  create_table "test_entries", force: true do |t|
    t.text     "content"
